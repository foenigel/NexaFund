...
const Footer = ({viewHomeSection}) => {
    return ( <div className="relative bg-white mt-8 col-span-12 grid grid-cols-2 h-auto place-items-start gap-6 px-4 border-t-2 border-customSkyBlueShadow pt-8 mb-8 md:grid-cols-4 md:px-0 md:mb-28">
        {
            FooterInfo.map(({title, links}, index) => (
                <div className="relative flex flex-col gap-1 w-full h-full justify-start">
